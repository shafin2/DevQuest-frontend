      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 mb-8">
          ...
          <p className="text-gray-600">
            Here's an overview of your projects and collaboration on DevQuest
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <button className="flex items-center p-4 border-2 border-gray-200 rounded-xl hover:border-indigo-600 hover:bg-indigo-50 transition-all group">
            ...
            <button className="flex items-center p-4 border-2 border-gray-200 rounded-xl hover:border-indigo-600 hover:bg-indigo-50 transition-all group">
              ...
              <div className="ml-4 text-left">
                <p className="font-semibold text-gray-900">Find Team Members</p>
